package eapli.base.net.autotaskexecutor;
...
class TCPExecutorThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Thread.sleep(5000); // Mock (Sim Automatic Task Execution)
            System.out.println("Automatic Task Executed Successfully.");

            response.setCode(SDP2021Code.AUTOTASK_RESPONSE.getCode());
        ...
        catch(IOException | InterruptedException ex) { System.out.println("Exception"); }
    }
}
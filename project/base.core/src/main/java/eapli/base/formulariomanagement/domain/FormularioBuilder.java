...
public class FormularioBuilder implements DomainFactory<Formulario> {
    ...
    public FormularioBuilder withAtributoList(List<Attribute> lstAttributes) {
    ...
    public Formulario build() {
        ...
        return new Formulario(this.m_oID, this.m_oNome, this.m_oTipoForm ,this.m_lstAttributes);
    }
}
